export default {
  ...
  socketEndpoint: process.env.NODE_ENV === 'production' ? 'ws://192.168.1.113:8080' : 'ws://localhost:8080',
  ...
  filesPath: process.env.NODE_ENV === 'production' ? 'http://192.168.1.113:8080' : 'http://localhost:8080',
