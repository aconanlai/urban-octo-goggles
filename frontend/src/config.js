export default {
  ...
  socketEndpoint: process.env.NODE_ENV === 'production' ? 'ws://192.168.1.17:8080' : 'ws://192.168.1.17:8080',
  ...
  filesPath: process.env.NODE_ENV === 'production' ? 'http://192.168.1.17:8080' : 'http://192.168.1.17:8080',
